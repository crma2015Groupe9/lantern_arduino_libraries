...
/*#ifndef M_RDY_LINE_HANDLE_CALLBACK
#define M_RDY_LINE_HANDLE_CALLBACK
    
    static void m_rdy_line_handle_callback(void){
...
{ 
  #ifdef M_RDY_LINE_HANDLE_CALLBACK
    m_rdy_line_handle_callback();
  #endif
